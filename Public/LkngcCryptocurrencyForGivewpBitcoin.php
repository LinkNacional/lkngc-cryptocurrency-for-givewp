 ...
 * @inheritDoc
 */
final class LkngcCryptocurrencyForGivewpBitcoin extends PaymentGateway {
    /**
     * @inheritDoc
     */
    public static function id(): string {
        return 'lkngc-cryptocurrencyforgivewp-bitcoin';
    }
    ...
    public function getLegacyFormFieldMarkup(int $formId, array $args): string {
        ...
        $walletBitcoin = esc_attr($wallets['bitcoin']);
        ...
        <fieldset id="lkngc_give_cc_fields" class="give-do-validate">
            ...
            <div id="lkn_cryptocurrency_wrapper" class="lkn_crypto_hidden">
               <a href="bitcoin:' . $walletBitcoin . '" target="_blank">
                    <div id="qrcode"></div>
                </a>

                <div id="lkn_crypto_price_wrapper">
                    <div><span>Donation amount:</span></div>
                    <div><span id="totalBtc">0.00000000</span><span> BTC</span></div>
                </div>
                ...
                <div id="lkn_cryptocurrency_input_wrapper">
                    ...
                    <div>
                        <span class="walletInput">' . $walletBitcoin . '</span>
                    </div>
                </div>
            ...
            <div id="btnBtcWrapper">
                <button type="button" id="btnDonateCrypto" class="give-btn lkn-btn-gateway" onclick="lkngcGerarPagamento(\'bitcoin\')">Generate QR Code</button>
            </div>
    ...
    public function createPayment(Donation $donation, $gatewayData): GatewayCommand {
        ...
        $wallet = LkngcCryptocurrencyForGivewpHelper::get_wallets()['bitcoin'];
    ...
    public function enqueueScript(int $formId): void {
        ...
        wp_enqueue_script(
            'lkngc-bitcoin-script-js',
            plugin_dir_url(__FILE__) . 'js/bitcoin-script.js',
            array('jquery'),
        ...
        $MenssageErrorBitcoin = __('Wallet Bitcoin Invalid or Empty.', 'lkngc-cryptocurrency-for-givewp');
        $walletBitcoin = ! empty($wallets['bitcoin']) && strlen($wallets['bitcoin']) > 10 ? $wallets['bitcoin'] : '';

        wp_localize_script('lkngc-bitcoin-script-js', 'lkngcGiveCryptoGlobalsBTC', array(
            'decimal_separator' => $decimal_separator,
            'thousand_separator' => $thousand_separator,
            'currency' => $currency,
            'walletBitcoin' => $walletBitcoin,
            'advDebug' => $advDebug,
            'MenssageErrorBitcoin' => $MenssageErrorBitcoin,
        ));

        wp_enqueue_script(
            'lkngc-bitcoin-give-cryptocurrency-qrcode-js',
        ...
        wp_enqueue_style(
            'lkngc-bitcoin-give-cryptocurrency-public-css',
